...
(function() {
  ...
  rendering = function() {
    var assets_path, assets_src, attr, body, e, error, head, j, k, l, len1, len2, len3, mobile_name, modern, negatives, ref, ref1, ref2, ref3, remove_attr_list;
    ...
    if (!is_modern_browser) {
      ...
      negatives = ['0', 'false', 'null', false, 0, null, void 0];
      if (ref1 = detector_url.toLowerCase(), indexOf.call(negatives, ref1) >= 0) {
        return;
      } else if (typeof detector_url !== 'string') {
        detector_url = '';
      }
      if (!detector_url || ((ref2 = detector_url.toLowerCase()) === 'true' || ref2 === '1')) {
        detector_url = '';
      }
