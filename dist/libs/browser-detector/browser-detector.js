...
(function() {
  var _black_list, baseObj, black_list, blackbrowser, body_template, browser, check_version, funcName, head_template, html, html5tags, i, is_exports, is_modern_browser, j, len, mobile, mobile_list, modern_browsers, n, o, properties, ready, readyEventHandlersInstalled, readyFired, readyList, readyStateChange, rendering, root, tags, version;
  ...
  if (/MSIE|Trident/.test(navigator.userAgent)) {
    ...
    if (window.HTMLElement) {
      ...
      tags = ['Unknown', 'UList', 'Title', 'TextArea', 'TableSection', 'TableRow', 'Table', 'TableCol', 'TableCell', 'TableCaption', 'Style', 'Span', 'Select', 'Script', 'Param', 'Paragraph', 'Option', 'Object', 'OList', 'Meta', 'Marquee', 'Map', 'Link', 'Legend', 'Label', 'LI', 'Input', 'Image', 'IFrame', 'Html', 'Heading', 'Head', 'HR', 'FrameSet', 'Frame', 'Form', 'Font', 'FieldSet', 'Embed', 'Div', 'DList', 'Button', 'Body', 'Base', 'BR', 'Area', 'Anchor'];
      html5tags = ['abbr', 'article', 'aside', 'audio', 'canvas', 'datalist', 'details', 'dialog', 'eventsource', 'figure', 'footer', 'header', 'hgroup', 'mark', 'menu', 'meter', 'nav', 'output', 'progress', 'section', 'time', 'video'];
      o = void 0;
      n = void 0;
      i = 0;
  ...
  rendering = function() {
    var assets_path, assets_src, attr, body, default_assets_src, e, error, head, k, l, len1, len2, len3, mobile_name, modern, p, ref, ref1, ref2, ref3, remove_attr_list;
    ...
    if (!is_modern_browser) {
      ...
      for (p = 0, len3 = remove_attr_list.length; p < len3; p++) {
        attr = remove_attr_list[p];
        html.removeAttribute(attr);
      }
      while (html.firstChild) {
        html.removeChild(html.firstChild);
