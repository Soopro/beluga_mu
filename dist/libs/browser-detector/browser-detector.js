...
(function() {
  var _black_list, black_list, blackbrowser, body_template, browser, check_version, detector_url, e, error, head_template, html, i, is_exports, is_modern_browser, len, mobile, mobile_list, modern_browsers, rendering, root, version;
  ...
  rendering = function() {
    var assets_path, assets_src, attr, body, e, error, head, j, k, l, len1, len2, len3, mobile_name, modern, ref, ref1, remove_attr_list;
    ...
    if (!is_modern_browser) {
      ...
      if (assets_src === '0' || assets_src === 'false' || assets_src === 'null' || assets_src === false || assets_src === 0 || assets_src === null || assets_src === (void 0)) {
        return;
      } else if (typeof assets_src !== 'string') {
        assets_src = '';
      } else if (assets_src === 'true' || assets_src === '1') {
        assets_src = '';
      }
      try {
  ...
  try {
    ...
    if (!detector_url || typeof detector_url !== 'string' || detector_url.indexOf('http') !== 0) {
      detector_url = '';
    }
