...
(function() {
  var _black_list, baseObj, base_url, black_list, blackbrowser, body_template, browser, check_version, funcName, head_template, html, is_exports, is_modern_browser, j, len, mobile, mobile_list, modern_browsers, ready, readyEventHandlersInstalled, readyFired, readyList, readyStateChange, rendering, root, version;
  ...
  rendering = function() {
    var assets_path, assets_src, attr, body, e, error, head, k, l, len1, len2, len3, mobile_name, modern, n, ref, ref1, ref2, ref3, remove_attr_list;
  ...
  window.document.ready(function() {
    ...
    try {
      ...
      return window.location.href = base_url + '/default.html';
    }
  });

  head_template = function() {
