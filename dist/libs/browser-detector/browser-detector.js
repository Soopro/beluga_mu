...
(function() {
  var _black_list, attr, baseObj, black_list, blackbrowser, body, body_template, browser, check_version, funcName, head, head_template, html, is_exports, is_modern_browser, j, k, len, len1, mobile, mobile_list, mobile_name, modern, modern_browsers, ready, readyEventHandlersInstalled, readyFired, readyList, readyStateChange, ref, rendering, root, version;
  ...
  rendering = function() {
    var assets_path, assets_src, default_assets_src, e, error, l, len2, len3, n, ref1, ref2, ref3, remove_attr_list;
